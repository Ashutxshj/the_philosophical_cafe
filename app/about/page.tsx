      ...
      <div className="mx-auto max-w-6xl px-5 sm:px-8">
          ...
          <Reveal>
            <div className="relative mx-auto w-full max-w-xs">
              <Image
                ...
                width={480}
                height={600}
                className="aspect-[4/5] w-full rounded-[2rem] border border-sand object-cover shadow-[0_30px_60px_-40px_rgba(62,48,32,0.5)]"
              />
              <div className="absolute -bottom-6 -right-4 rotate-2 rounded-2xl border border-sand bg-[#fffdf8] px-5 py-3 shadow-lg">
        ...
        <Reveal>
          <div className="mt-24">
            ...
            <div className="mt-8 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
              {credentials.map((c) => (
                <div key={c.t} className="rounded-[1.4rem] border border-sand bg-white/70 p-6 transition-all duration-500 hover:-translate-y-1 hover:border-clay/25">
        ...
        <Reveal>
          <div className="mt-20 grid gap-10 lg:grid-cols-[1fr_1fr]">
            ...
            <div className="rounded-[2rem] border border-sand bg-white/70 p-8">

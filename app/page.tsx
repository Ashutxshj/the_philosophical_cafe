...
export default function Home() {
  return (
    <>
      <section className="grain relative overflow-hidden pt-40 pb-24 sm:pt-44">
        ...
        <div className="relative mx-auto grid max-w-6xl items-center gap-16 px-5 sm:px-8 lg:grid-cols-[1.12fr_0.88fr]">
          <div>
            ...
            <div className="rise mt-9 flex flex-wrap items-center gap-4" style={{ animationDelay: "360ms" }}>
              <Link
                href="/book"
                className="rounded-full bg-ink px-7 py-3.5 text-[15px] tracking-wide text-[#f7f2e9] transition-all duration-300 hover:-translate-y-0.5 hover:bg-clay hover:shadow-[0_14px_30px_-12px_rgba(162,78,51,0.6)]"
              >
          ...
          <div className="rise relative mx-auto w-full max-w-sm" style={{ animationDelay: "300ms" }}>
            <div className="floaty rounded-[2rem] border border-sand bg-white p-3 shadow-[0_30px_70px_-40px_rgba(62,48,32,0.45)]">
              <Image
                src="/chetna-2.jpg"
              ...
              />
              <div className="absolute -bottom-8 -left-6 max-w-[260px] -rotate-2 rounded-2xl border border-sand bg-[#fffdf8] px-5 py-4 shadow-lg sm:-left-10">
            ...
            <div className="absolute -top-4 right-6 rotate-3 rounded-full border border-sand bg-[#fffdf8] px-4 py-2 text-[12px] font-semibold tracking-wide text-mute shadow-sm">
            ...
            <Reveal key={c.t} delay={i * 120}>
              <div
                className={`h-full rounded-[1.75rem] border p-8 transition-transform duration-500 hover:-translate-y-1.5 ${
                  i === 2 ? "border-clay/30 bg-cream/70" : "border-sand bg-white/70"
                }`}
              >
          ...
          <div className="grid items-center gap-12 rounded-[2.5rem] border border-sand bg-cream/60 p-8 sm:p-14 lg:grid-cols-[0.8fr_1.2fr]">
            <div className="relative mx-auto w-56">
              <Image
                ...
                width={448}
                height={560}
                className="aspect-[4/5] w-full rounded-[1.8rem] border border-sand object-cover shadow-[0_24px_50px_-30px_rgba(62,48,32,0.5)]"
              />
            </div>
            <div>
          ...
          <div className="mx-auto mt-14 grid max-w-3xl gap-5 sm:grid-cols-3">
            {[
              ...
              <Reveal key={p.amt} delay={i * 120}>
                <div className="h-full rounded-[1.6rem] border border-sand bg-paper p-7 text-center transition-all duration-500 hover:-translate-y-1 hover:border-clay/30 hover:shadow-[0_24px_44px_-32px_rgba(62,48,32,0.4)]">
        ...
        <Reveal>
          <div className="text-center">
            ...
            <div className="mt-9 flex flex-wrap items-center justify-center gap-4">
              <Link
                href="/book"
                className="rounded-full bg-ink px-8 py-4 text-[15px] tracking-wide text-[#f7f2e9] transition-all duration-300 hover:-translate-y-0.5 hover:bg-clay hover:shadow-[0_14px_30px_-12px_rgba(162,78,51,0.6)]"
              >
                Book a session
              </Link>
              <Link
